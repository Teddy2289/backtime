                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <dl class="grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900">{{ team.owner?.name || 'Non spécifié'
                                                }}</dd>
                                        </div>
                                ...
                                <div v-if="members.length > 0">
                                    <h4 class="text-sm font-medium text-gray-900 mb-2">Membres de l'équipe</h4>
                                        ...
                                        <ul class="divide-y divide-gray-200">
                                            <li v-for="member in members" :key="member.id"
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        <p class="text-sm font-medium text-gray-900">{{ member.name }}
                                                        </p>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div class="bg-gray-50 p-3 rounded-lg">
                                            ...
                                            <p class="mt-1 text-lg font-semibold text-gray-900">{{
                                                statistics.total_projects || 0 }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-3 rounded-lg">
                                            <p class="text-xs text-gray-500">Membres</p>
                                            <p class="mt-1 text-lg font-semibold text-gray-900">{{
                                                statistics.total_members || 0 }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-3 rounded-lg">
                                            <p class="text-xs text-gray-500">Actifs</p>
                                            <p class="mt-1 text-lg font-semibold text-gray-900">{{
                                                statistics.active_projects || 0 }}</p>
                                        </div>
                                        <div class="bg-gray-50 p-3 rounded-lg">
                                            <p class="text-xs text-gray-500">Terminés</p>
                                            <p class="mt-1 text-lg font-semibold text-gray-900">{{
                                                statistics.completed_projects || 0 }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
import type { Team, TeamMember, TeamStatistics } from '@/services/team.service'
...
onMounted(async () => {
    ...
    try {
        ...
        statistics.value = await teamStore.getTeamStatistics(props.team.id)
    } catch (error) {
