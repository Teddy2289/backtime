            ...
            <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-lg">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-primary/10 via-secondary/5 to-primary/5">
                    <div class="flex items-center justify-between">
                        ...
                        <button @click="$emit('close')" class="text-dark hover:text-blue-200 transition-colors p-1">
                ...
                <div class="px-6 py-5 max-h-[70vh] overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="space-y-1">
                                <span class="text-sm font-medium text-gray-500">Inscription</span>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-gray-900">{{ formatLastLogin(user.last_login_at) }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Avatar URL -->
                        <div v-if="user.avatar_url || user.avatar" class="mt-4 p-4 bg-blue-50 rounded-lg">
                            <h4 class="text-sm font-medium text-gray-700 mb-2">URL de l'avatar</h4>
                            <div class="flex items-center gap-2">
                                <input :value="getAvatarUrl(user)" 
                                       readonly
                            ...
                            <p class="text-xs text-gray-500 mt-2">
                                Cliquez sur "Copier" pour copier l'URL dans le presse-papier
                            </p>
                        </div>
                    </div>
                </div>
